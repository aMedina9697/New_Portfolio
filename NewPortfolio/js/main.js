jQuery(document).ready(function() {
  ...
  if (
    ...
    jQuery("html, .menu-wraper").niceScroll({
      cursorcolor: "#b1b1b1",
      scrollspeed: 100,
      mousescrollstep: 80,
      cursorwidth: "12px",
    ...
    jQuery(".post-num-comments a").click(function(e) {
      ...
      jQuery("html")
        .getNiceScroll(0)
        .doScrollTop(jQuery(this.hash).offset().top);
    });
  ...
  jQuery("blockquote.inline-blockquote")
    .prev("p")
    .addClass("wrap-blockquote");
  jQuery("blockquote.inline-blockquote")
    .next("p")
    .addClass("wrap-blockquote");
  ...
  var grid = jQuery(".grid").imagesLoaded(function() {
    ...
    jQuery(".portfolio-text-holder").each(function() {
      jQuery(this)
        .find("p.portfolio-text")
        .css("margin-top", jQuery(this).height() / 2 - 20);
    });
...
jQuery(window).load(function() {
  ...
  jQuery(".menu-wraper img")
    .width(jQuery(".header-logo img").width())
    .height(jQuery(".header-logo img").height());
  ...
  jQuery(".image-slider-wrapper").each(function() {
    ...
    var pagination_width = jQuery(this)
...
var contactFormWidthFix = function() {
  jQuery(".contact-form")
    .find(".custom-text-class")
    .each(function() {
      var textWidth = jQuery(this).innerWidth() + 1;
      jQuery(this)
        .next(".custom-field-class")
        .width(jQuery(".contact-form").innerWidth() - textWidth - 5);
      jQuery(this)
        .next(".custom-field-class")
        .find("input")
        .outerWidth(jQuery(".contact-form").innerWidth() - textWidth - 5);
      jQuery(this)
        .next(".custom-field-class")
        .find("textarea")
        .outerWidth(jQuery(".contact-form").innerWidth() - textWidth - 5);
...
var multiClickFunctionStop = function(e) {
  if (
    jQuery(e.target).is(".menu-wraper") ||
    jQuery(e.target).is("#toggle") ||
    jQuery(e.target).is("#toggle div")
  ) {
